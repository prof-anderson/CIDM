...
d <- data.frame(A_B = c(90), A_C = c(90), B_C = c(90))
...
# D, E, F are alternatives.
# D:  Advanced Bionics 
# E:  Med-El
# F:  cochlear 

d <- data.frame(A_B = c(90), A_C = c(90), B_C = c(90),
								A.D_E = c(90), A.D_F = c(10), A.E_F = c(10),
								B.G_H = c(90), B.G_I = c(10), B.H_I = c(10),
								C.J_K = c(90), C.J_L = c(10), C.K_L = c(10))
