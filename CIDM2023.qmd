...
```{r, echo=FALSE}
temp <- d2_0
colnames (d2_0) <- c("A\\_B", "A\\_C", "A\\_D", "A\\_E", 
                              "B\\_C", "B\\_D", "B\\_E", 
                                       "C\\_D", "C\\_E",
                                                "D\\_E")
kbl(d2_0, 
